...
CREATE TABLE IF NOT EXISTS `customer_bank_details` (
  ...
  `Pin` int(10) NOT NULL DEFAULT '1234',
...
(1001, 'John Doe', 1234, 'Savings Account', '5000.00', 'Main Branch'),
(1002, 'Jane Smith', 1234, 'Current Account', '2500.50', 'Downtown Branch'),
(1003, 'Alice Johnson', 1234, 'Fixed Account', '10000.00', 'Main Branch'),
(1004, 'Bob Brown', 1234, 'Student Serve Account', '750.25', 'Campus Branch'),
(1005, 'Eve Davis', 1234, 'Special Savers Account', '15000.75', 'Downtown Branch');
